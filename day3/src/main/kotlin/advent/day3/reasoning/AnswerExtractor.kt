...
/**
 * Достаёт из развёрнутого решения ту одну строку, которую можно сопоставить с другими способами.
 *
 * Сравнивать способы по полному тексту бессмысленно: пошаговое решение и разбор группы
 * экспертов не совпадут никогда, даже когда пришли к одному и тому же результату.
 */
@Component
class AnswerExtractor {
     ...
     * Это грубее, но лучше, чем ничего: у прямого ответа итог обычно и есть последняя строка.
     */
