...
data class ServerConfig(
    ...
    companion object {
        ...
        private const val DEFAULT_PORT = 8098
        private const val DEFAULT_USERS_API_URL = "http://localhost:8097"
        ...
        fun fromEnvironment(): ServerConfig = ServerConfig(
            ...
            usersApiUrl = System.getenv("USERS_API_URL")?.takeIf { it.isNotBlank() } ?: DEFAULT_USERS_API_URL,
