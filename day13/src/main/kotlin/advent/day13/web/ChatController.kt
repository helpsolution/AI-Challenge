...
class ChatController(
    ...
    fun acceptStyleSuggestion(@PathVariable id: Long): advent.day13.memory.MemoryItem {
    ...
    fun longTerm(): List<advent.day13.memory.MemoryItem> =
        longTerm.list(agent.properties.longTermLimit)

    @PostMapping("/memory/long-term")
    fun upsertLongTerm(@RequestBody request: UpsertMemoryRequest): advent.day13.memory.MemoryItem =
        longTerm.upsert(
            NewMemoryItem(
                kind = request.kind,
