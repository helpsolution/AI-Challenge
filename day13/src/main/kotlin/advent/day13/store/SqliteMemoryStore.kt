...
class SqliteMemoryStore(
    ...
    override fun save(memory: TaskMemory): TaskMemory {
        ...
        jdbc.sql(
            """
            INSERT INTO post_task (session_id, state, current_step, expected_action, idea, thesis, plan, draft, notes, style_suggestion, updated_at)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
