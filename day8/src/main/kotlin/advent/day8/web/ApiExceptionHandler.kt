...
class ApiExceptionHandler {
     ...
     * потому, что сломалось не у нас, а выше; но чей именно это был `400` и что в нём
     * написано, интерфейс должен показать дословно — в этом дне ошибка про лимит
     * контекста и есть результат.
     */
