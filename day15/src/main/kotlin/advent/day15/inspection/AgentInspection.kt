...
import advent.day15.agent.PromptBuild
...
data class AgentTrace(
    ...
    val invariantVerdict: advent.day15.invariant.InvariantVerdict? = null,
    val transitionVerdict: advent.day15.lifecycle.TransitionVerdict? = null,
...
class AgentInspection(
    ...
    fun finish(trace: AgentTrace, error: String? = null): AgentTrace {
        ...
        return store.save(trace.copy(status = when {
            error != null -> "ERROR"
            trace.transitionVerdict?.allowed == false -> "TRANSITION_REFUSED"
            trace.invariantVerdict?.allowed == false -> "REFUSED"
            else -> "SUCCESS"
