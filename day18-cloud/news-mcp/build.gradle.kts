...
description = "MCP-сервер: три инструмента поверх REST API сервиса статей Хабра"
...
application {
    mainClass.set("advent.habr.mcp.MainKt")
}
...
dependencies {
    ...
    // клиент: ходим в сервис статей, не блокируя поток корутины
...
tasks.jar {
    archiveFileName.set("news-mcp.jar")
    manifest {
        attributes["Main-Class"] = "advent.habr.mcp.MainKt"
    }
