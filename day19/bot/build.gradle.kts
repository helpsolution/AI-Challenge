...
description = "Telegram-бот с агентом: DeepSeek сам проходит цепочку инструментов MCP"
...
application {
    mainClass.set("advent.pipeline.bot.MainKt")
}
...
tasks.jar {
    ...
    manifest {
        attributes["Main-Class"] = "advent.pipeline.bot.MainKt"
    }
...
/** Запуск из корня day19: там лежат .env и каталог data. */
