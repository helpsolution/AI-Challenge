...
import advent.day14.agent.PromptBuild
...
data class AgentTrace(
    ...
    val invariantVerdict: advent.day14.invariant.InvariantVerdict? = null,
    val deliveredReply: String? = null,
)
...
class AgentInspection(
    ...
    fun finish(trace: AgentTrace, error: String? = null): AgentTrace {
        ...
        return store.save(trace.copy(status = if (error != null) "ERROR" else if (trace.invariantVerdict?.allowed == false) "REFUSED" else "SUCCESS", finishedAt = clock.instant(),
