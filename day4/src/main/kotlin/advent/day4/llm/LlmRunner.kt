package advent.day4.llm

import advent.day4.config.DeepSeekProperties
 ...
 *
 * Наследник LlmRunner из дня 3 без изменений: прогонов много, каждый идёт
 * со своей температурой, а всё остальное в запросе у них общее.
 */
@Service
class LlmRunner(
